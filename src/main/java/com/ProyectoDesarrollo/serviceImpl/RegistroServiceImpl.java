...
import com.ProyectoDesarrollo.service.CorreoService;
import com.ProyectoDesarrollo.service.RegistroService;
...
public class RegistroServiceImpl implements RegistroService {
    ...
    public Model recordarUsuario(Model model, Usuario usuario)
        ...
        if (usuario2 != null) {
            ...
            mensaje = String.format(
                    messageSource.getMessage("registro.mensaje.recordar.ok", null,Locale.getDefault()), usuario.getCorreo());
        } else {
            mensaje = String.format(messageSource.getMessage("registro.mensaje.no.existe", null,Locale.getDefault()), usuario.getUsername(), usuario.getCorreo());
        }
        model.addAttribute(
                "titulo",
                messageSource.getMessage(
